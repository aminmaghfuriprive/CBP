      ...
      <div className="overflow-x-auto">
        <table className="w-full text-sm text-left">
          <thead className="text-xs text-slate-500 dark:text-slate-400 uppercase bg-slate-50 dark:bg-slate-800/60 border-b border-slate-200 dark:border-slate-800">
            <tr>
              <th className="px-6 py-4 font-bold">Klien & Kasus</th>
              <th className="px-6 py-4 font-bold">Divisi</th>
              <th className="px-6 py-4 font-bold">Tahapan</th>
            ...
            {cases.map((c) => (
              ...
              >
                <td className="px-6 py-4">
                  <div className="font-bold text-cbp-navy dark:text-white group-hover:text-cbp-gold transition-colors">
                    {c.clientName}
                  </div>
                  <div className="text-xs text-slate-500 dark:text-slate-400 mt-0.5 font-medium truncate max-w-[200px]">
                    {c.caseType}
                  </div>
                </td>
                <td className="px-6 py-4">
                  <span className="text-xs bg-slate-100 dark:bg-slate-800 text-slate-600 dark:text-slate-300 px-2 py-1 rounded border border-slate-200 dark:border-slate-700">
                    {c.division.split(' ')[0]}...
                  </span>
                </td>
                <td className="px-6 py-4">
                  ...
                  <div className="text-[10px] text-slate-400 mt-1">Upd: {c.lastUpdate}</div>
                </td>
                <td className="px-6 py-4">
                  <StatusBadge status={c.status} />
                </td>
                <td className="px-6 py-4 text-right">
                  <button className="p-2 rounded-full hover:bg-slate-100 dark:hover:bg-slate-800 text-slate-400 hover:text-cbp-navy dark:hover:text-white transition-colors">
