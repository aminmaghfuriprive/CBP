      ...
      <div className="bg-white w-full max-w-md rounded-lg shadow-2xl overflow-hidden flex flex-col max-h-[90vh]">
        ...
        <div className="flex-1 overflow-y-auto bg-slate-50 p-4">
          ...
          {step === 'PAYMENT_DETAIL' && selectedBank && (
            <div className="space-y-6 animate-in slide-in-from-right-4 duration-300">
              ...
              <div className="bg-white p-6 rounded-xl border border-slate-200 shadow-sm text-center">
                 ...
                 <div className="bg-yellow-50 border border-yellow-100 p-3 rounded-lg text-xs text-yellow-700 text-left mb-6">
                    <p className="font-bold mb-1">Instruksi:</p>
                    <ol className="list-decimal list-inside space-y-1">
                       <li>Buka Mobile Banking {selectedBank.name}.</li>
                       <li>Pilih menu Pembayaran / Virtual Account.</li>
                       <li>Masukkan nomor di atas.</li>
                       <li>Periksa nominal tagihan.</li>
                    </ol>
                 </div>
          ...
          {step === 'PROCESSING' && (
            <div className="h-full flex flex-col items-center justify-center text-center py-12">
               ...
               <h3 className="font-bold text-slate-800">Memproses Pembayaran...</h3>
        ...
        <div className="p-3 bg-slate-100 border-t border-slate-200 text-center">
           <p className="text-[10px] text-slate-400 font-bold flex items-center justify-center gap-1">
             <ShieldCheck className="h-3 w-3" /> Secured by CBP Payment
           </p>
        </div>
      </div>
    </div>
