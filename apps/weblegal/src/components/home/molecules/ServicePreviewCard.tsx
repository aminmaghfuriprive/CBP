...
export const ServicePreviewCard: React.FC<ServicePreviewCardProps> = ({ service }) => {
  ...
  return (
    <div className="group relative bg-white dark:bg-slate-950 rounded-2xl p-10 shadow-sm hover:shadow-2xl transition-all duration-500 border border-slate-200 dark:border-slate-800 overflow-hidden h-full flex flex-col">
      ...
      <div className="w-16 h-16 bg-slate-50 dark:bg-slate-900 rounded-2xl flex items-center justify-center mb-8 group-hover:bg-cbp-navy dark:group-hover:bg-cbp-gold transition-colors duration-500 border border-slate-100 dark:border-slate-800">
