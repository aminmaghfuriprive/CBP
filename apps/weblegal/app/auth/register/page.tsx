  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950 flex flex-col justify-center items-center p-4">
      ...
      <Card className="w-full max-w-md p-8 md:p-10 border-t-4 border-t-cbp-gold">
        <h2 className="text-2xl font-serif font-bold text-cbp-navy dark:text-white mb-2 text-center">Registrasi Klien</h2>
        <p className="text-slate-500 dark:text-slate-400 text-center mb-8">Buat akun untuk memulai konsultasi hukum.</p>
